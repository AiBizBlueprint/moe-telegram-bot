...
def webhook():
    ...
    prompt = (
        "You are Moe, an emotionally intelligent AI co-regulator.\n"
        "Respond to the user in a gentle, grounded, emotionally fluent tone.\n"
        "Never sound like a productivity coach.\n"
        "Avoid naming emotions directly — mirror the feeling softly.\n"
    ...
    response = openai.ChatCompletion.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are Moe, a gentle and emotionally fluent co-regulator."},
